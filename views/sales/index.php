...
?>
            ...
            <tr>
                ...
                <td class="valorcolumna"><?php echo number_format(($r->commission*($r->amount/100)) + $r->amount); ?>
                </td>
...
if (file_exists($directorio))
	...
	?>
                ...
                <td class="acciones" style="text-align:center"><i onclick='AprobarCoin(<?php echo $r->ID; ?>)'
                        style='display:inline;color:green;cursor:pointer' class='fa fa-check-square-o fa-2x'></i> &nbsp;
                    &nbsp; &nbsp;<i onclick='EliminarCoin(<?php echo $r->ID; ?>)'
                        style='display:inline;color:red;cursor:pointer' class='fa fa-close fa-2x'></i></td>
            </tr>
            <?php endforeach; ?>
